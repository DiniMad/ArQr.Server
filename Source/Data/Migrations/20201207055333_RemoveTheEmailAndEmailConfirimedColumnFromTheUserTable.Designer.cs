...
namespace Data.Migrations
{
    ...
    [Migration("20201207055333_RemoveTheEmailAndEmailConfirimedColumnFromTheUserTable")]
    partial class RemoveTheEmailAndEmailConfirimedColumnFromTheUserTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.QrCode", b =>
                {
                    ...
                    b.Property<long?>("MediaContentId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Service", b =>
                {
                    ...
                    b.Property<int>("ExpireDurationInDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.QrCode", b =>
                {
                    b.HasOne("Domain.MediaContent", "MediaContent")
                        .WithMany()
